...
$products = [];
$sql = "SELECT id, name, category, image_path FROM products ORDER BY created_at DESC";
...
<body class="admin-body">
    ...
    <main class="admin-main-content">
        <div class="admin-container">
            ...
            <a href="create.php" class="add-item-btn">Tambah Produk Baru</a>
            <table class="admin-table">
                <thead>
                    <tr><th>ID</th><th>Nama Produk</th><th>Kategori</th><th>Gambar</th><th>Aksi</th></tr>
                </thead>
                <tbody>
                    <?php if (count($products) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a href="../../../app/controllers/ProductController.php?action=delete_product&id=<?php echo $product['id']; ?>" class="delete" onclick="return confirm('Yakin hapus?');">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
