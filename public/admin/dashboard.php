...
<head>
    ...
    <style>
        ...
        .admin-dashboard-card{background-color:#FFFFFF;border:1px solid #E9ECEF;border-radius:12px;padding:1.5rem;text-align:center;}
        .admin-dashboard-card h3{margin-bottom:1rem;}
        .admin-dashboard-card p{margin-bottom:1.5rem; color:#6C757D}
    </style>
</head>
<body class="admin-body">
    <header class="admin-header-main">
        <div class="header-container">
            ...
            <span class="admin-welcome-text">Selamat Datang, <?php echo htmlspecialchars($_SESSION['username']); ?>!</span>
        </div>
    </header>
    ...
    <main class="admin-main-content">
        <div class="admin-container">
            <h2 style="text-align:center;">Kelola Konten Website</h2>
            <div class="dashboard-grid">
                <div class="admin-dashboard-card">
                    <h3>Produk & Katalog</h3>
                    <p>Tambah, edit, atau hapus item produk dan katalog.</p>
                    <a href="products/manage.php" class="button">Kelola Produk</a>
                </div>
                <div class="admin-dashboard-card">
                    <h3>Portofolio</h3>
                    <p>Tambah, edit, atau hapus item portofolio.</p>
                    <a href="portfolio/manage.php" class="button">Kelola Portofolio</a>
                </div>
                <div class="admin-dashboard-card">
                    <h3>Pengaturan Umum</h3>
                    <p>Ubah info kontak, Tentang Kami, Visi, Misi, dan lainnya.</p>
                    <a href="settings.php" class="button">Kelola Pengaturan</a>
                </div>
            </div>
        </div>
    </main>
